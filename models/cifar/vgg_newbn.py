...
__all__ = [
  'vgg11_newbn','vgg13_newbn', 'vgg16_newbn',
    'vgg19_newbn',
]
...
def make_layers(cfg, batch_norm=False):
    ...
    for v in cfg:
        if v == 'M':
            ...
            if batch_norm:
                layers += [conv2d, NewBatchNorm2d(v), nn.ReLU(inplace=True)]
            else:
