...
__all__ = [
    'VGGFRN', 'vgg11', 'vgg11_oldfrn', 'vgg13', 'vgg13_oldfrn', 'vgg16', 'vgg16_oldfrn',
    'vgg19_oldfrn', 'vgg19',
]
...
def make_layers(cfg, batch_norm=False):
    ...
    for v in cfg:
        if v == 'M':
            ...
            if batch_norm:
                layers += [conv2d, OldFilterResponseNormalization(v), nn.ReLU(inplace=True)]
            else:
