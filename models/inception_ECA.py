...
class InceptionV3(nn.Module):
    ...
    def __init__(self, num_classes=100):
        ...
        self.se1 = EcaLayer(192)
        # naive inception module
        self.Mixed_5b = InceptionA(192, pool_features=32)
        self.se2 = EcaLayer(256)
        self.Mixed_5c = InceptionA(256, pool_features=64)
        self.se3 = EcaLayer(288)
        self.Mixed_5d = InceptionA(288, pool_features=64)
        self.se4 = EcaLayer(288)
        # downsample
        self.Mixed_6a = InceptionB(288)
        self.se5 = EcaLayer(768)

        self.Mixed_6b = InceptionC(768, channels_7x7=128)
        self.se6 = EcaLayer(768)
        self.Mixed_6c = InceptionC(768, channels_7x7=160)
        self.se7 = EcaLayer(768)
        self.Mixed_6d = InceptionC(768, channels_7x7=160)
        self.se8 = EcaLayer(768)
        self.Mixed_6e = InceptionC(768, channels_7x7=192)
        self.se9 = EcaLayer(768)
        # downsample
        self.Mixed_7a = InceptionD(768)
        self.se10 = EcaLayer(1280)
        self.Mixed_7b = InceptionE(1280)
        self.se11 = EcaLayer(2048)
        self.Mixed_7c = InceptionE(2048)
        self.se12 = EcaLayer(2048)
        # 6*6 feature size
