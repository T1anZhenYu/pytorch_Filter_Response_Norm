...
def main():
    ...
    # optimizer = optim.SGD(model.parameters(), lr=args.lr*arg, momentum=args.momentum, weight_decay=args.weight_decay)
    optimizer = optim.SGD(model.parameters(), lr=args.lr*args.train_batch/256, momentum=args.momentum, \
